...
urlpatterns = [
    ...
    path('inprocess/detail/<int:bpk>/coldsideaddition/', CreateDryhopDateView.as_view(), name="coldside"),
    ...
    path('archive/detail/<int:bpk>/coldsideaddition/', CreateDryhopDateView.as_view(), name="coldside"),
